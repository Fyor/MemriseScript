//Beginning of the Script, made by Voer.
function aFunction() {
var x = $(".qquestion").text().trim();

// This is the Array which is used in the Script. You would have to change this for your own use. I have provided a file which you can use for the Array with aditional information.
// This first array is for the words that are asked in the top of the screen.
...
// This is the second array which is used to fill in the correct answer.
...
// This is for filling in the write answer.
if (list_length == 0 && $(".roundy.shiny-box").length) {
	$(".roundy").val(question);
	$(".next-button").click();
}

// This is for the answer where the buttons need to be pressed.
...
// The "500" sets the speed for the timer. If you set it too fast it might not work!
var interval = setInterval(aFunction, 500);
//Eind van Script Multiple Choice

//If there are two words with the same translation. It doesn't work properly, but will skip it and give you no points.
